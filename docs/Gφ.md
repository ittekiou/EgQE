...
φGenesisismとは、**分岐（φ）としての生成（Genesis）を基礎とする非閉包生成思想**である。
...
見るでもなく、追うでもなく、**生起そのものに関与する立場**である。
