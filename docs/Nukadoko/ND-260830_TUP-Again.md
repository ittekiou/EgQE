...
公開版 [TUP-01｜TUP-Again ──「何が更新するか」から「更新はいかにあるか」へ｜ From “What Updates?” to “How Is Updating?”](https://camp-us.net/articles/TUP-01_TUP-Again_How-Is-Updating.html)  
...
$$
Updating\;?_{\mathrm{HOW}}\;消え現れ
$$

$$
Life\;?_{\mathrm{HOW}}\;消え現れ
$$

$$
Feeling\;?_{\mathrm{HOW}}\;消え現れ
$$

$$
HOW\ 消え現れ\;?_{\mathrm{IMA\text{-}KOKO}}\;IMA\text{-}KOKO
$$

## 留保

- `Feeling` と「消え現れ」の relation は未決。
- 炎は例証でもモデルでもなく、現時点では Probe。
- 「感じる」と `Feeling` の前後関係は確定しない。
- `Updating / Life / Feeling / IMA-KOKO` の各式は定式化ではなく、問いの形を保存する杭。
- 整理によって生ログの生成順や揺れを消さない。
...
DPH、Feeling／AJIWAI、TUPの三坑道が、**矢印 notation／HOW の問題**で合流したように見える。

- DPHでは、Γや direction-set を掘るなかで、数学・物理構文の側から矢印の前提が問題になった。
- Feeling／AJIWAIでは、WHATを追うなかで、WHATとWHATを結ぶ relation がいかにあるかという HOW が露出した。
- TUP-Againでは、TUP自身が用いてきた矢印そのものが問い返され始めた。
...
と置き直したとき、項のあいだにある **relation／矢印そのものが、HOWあるのか**という問いが露出した。その岩肌に対する Probe として「消え現れ」が見えているだけであり、欠けた中間項への回答として採用しない。
