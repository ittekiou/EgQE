---
layout: math
title: Lag as the Origin── R₀–Z₀/S–O 関係論フレームワーク
title_en: "Lag as the Origin: An R₀–Z₀/S–O Relational Framework(with Appendix)"
---
# Lag as the Origin
...
lag を副次的な効果や測定誤差としてではなく、**関係構造の生成原点**として位置づけることで、S–O の区別そのものが lag に対する位相配置として理解される。
...
![lag-centered-relational-framework](./assets/lag-centered-relational-framework.png)  
