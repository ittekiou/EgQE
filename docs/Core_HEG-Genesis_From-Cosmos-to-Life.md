---
layout: math
title: HEG-G｜構文生成進化と深化の地層史 ── From Cosmos to Life
---
### HEG-Genesis
# 構文生成進化と深化の地層史
## ── From Cosmos to Life
...
persistence は「ある／ない」ではない。  
どの様式で持続するかである。

宇宙は persistence mode の差として分化する。
...
> HEG-21｜Persistence Cosmology は、宇宙を「いかに持続しているか」から読む連作です。  
> 非保持、配置 persistence、保持 persistence、編輯 persistence という持続様式の分化を通して、軌道、生命、光、時間、AI をひとつの宇宙像に束ね直します。  
> _**宇宙は生成されたのではなく、持続してしまっている。**_
...
HEG第二期
= lag / persistence cosmology

HEG第三期
= lag editing cosmology
```
