...
### — _From Compartment to “Update of WHAT?”_
# Protocellを境界からなぞる
...
$$
\boxed{ Visible\ Compartment \neq Effective\ Compartmentalization }
$$
...
これはSource vocabularyの列挙ではなく、異なる記述を不用意に同一視しないための**Audit**である。

ここでは、複数の概念を同時に分離しておくための**Framework Distinction**として用いる。
...
$$
\boxed{ Maintenance \neq Self\text{-}Maintenance }
$$

$$
\boxed{ Self\text{-}Maintenance \neq Self\text{-}Sufficiency }
$$
...
$$
\boxed{ Source: Difference|Condition|Subsequent\ Relation }
$$

$$
\boxed{ TUP\ Probe: Encounter?|Trace?|Next\ Relation }
$$
...
$$
\boxed{ What\ remains\ traceable when\ identity\ does\ not? }
$$
...
Hanczyc, M. M., Fujikawa, S. M., & Szostak, J. W. (2003). “Experimental Models of Primitive Cellular Compartments: Encapsulation, Growth, and Division.” _Science_, 302, 618–622.

Chen, I. A., Roberts, R. W., & Szostak, J. W. (2004). “The Emergence of Competition Between Model Protocells.” _Science_, 305, 1474–1476.

Zhu, T. F., & Szostak, J. W. (2009). “Coupled Growth and Division of Model Protocell Membranes.” _Journal of the American Chemical Society_, 131, 5705–5713.

Adamala, K., & Szostak, J. W. (2013). “Competition between model protocells driven by an encapsulated catalyst.” _Nature Chemistry_, 5, 495–501.

Jia, T. Z., Hentrich, C., & Szostak, J. W. (2014). “Rapid RNA Exchange in Aqueous Two-Phase System and Coacervate Droplets.” _Origins of Life and Evolution of Biospheres_, 44, 1–12.

Engelhart, A. E., Adamala, K. P., & Szostak, J. W. (2016). “A simple physical mechanism enables homeostasis in primitive cells.” _Nature Chemistry_, 8, 448–453.
...
Auditには、個々の概念の同一化を止める**Local Distinction**と、複数の概念を同時に分離しておく**Framework Distinction**がある。  
