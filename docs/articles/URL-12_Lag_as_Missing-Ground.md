---
layout: math
title: URL-12｜なぜ生命論は解けなかったのか ── lag不在の四つのアポリア
title_en: "URL-12｜Lag as the Missing Ground: Why Has the Question of Life Remained Unresolved? — Four Aporias from the Absence of Lag"
---
...
- life as internal recursion
    
- viruses as external recursion
    
- society and AI as higher-order external recursion
...
- Mₚ: physical membrane
    
- Mₛ: syntactic membrane
...
[SN-LIF-10｜A Transitional Phase Theory of Life and Matter](https://camp-us.net/articles/SN-LIF-10_Life-and-Matter_Transitional-Phase.html)  
...
これらに共通するのは、**他者が常に「後から現れるもの」として扱われている**ことである。
...
したがって膜は、分離するものではなく、**関係を折り返す装置**である。
