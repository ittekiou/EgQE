---
layout: math
title: GE-05｜orderingはなぜ時間を生むのか ── 反復・痕跡列・不可逆性
title_en: GE-05｜Why Does Ordering Generate Time? ── Repetition, Trace Sequence, and Irreversibility
---
...
[GE-04](https://camp-us.net/articles/GE-04_Where-Coordinate-Come-From.html)では、複数 trace の間に差異構造が生じ、そこから比較可能性・座標・順序が発生することを示した。
...
In [GE-04](https://camp-us.net/articles/GE-04_Where-Coordinate-Come-From.html), it was shown that a structure of difference arises among multiple traces, generating comparability, coordinate, and ordering.
...
[GE-03](https://camp-us.net/articles/GE-03_Why-Closure-Tend-to-Occur.html)では、trace を「遭遇が局所に残した非対称性」として定義した。
...
In [GE-03](https://camp-us.net/articles/GE-03_Why-Closure-Tend-to-Occur.html), trace was defined as the asymmetry left locally by an encounter.
...
ここで [GE-04](https://camp-us.net/articles/GE-04_Where-Coordinate-Come-From.html) の ΔR' が戻ってくる。
...
Here, ΔR' from [GE-04](https://camp-us.net/articles/GE-04_Where-Coordinate-Come-From.html) returns.
...
構造的不可逆性と累積的不可逆性が重なるとき、trace は単なる蓄積ではなく**列**になる。
...
[GE-04](https://camp-us.net/articles/GE-04_Where-Coordinate-Come-From.html) では ordering を「比較可能な差異に方向を与える操作」として定義した。
...
In [GE-04](https://camp-us.net/articles/GE-04_Where-Coordinate-Come-From.html), ordering was defined as the operation of giving direction to comparable differences.
