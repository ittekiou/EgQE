---
title: SAW-10｜The Constancy of the Speed of Light as a Syntactic Assumption── 光速度不変原理の構文的再定位
subtitle: 光速度不変原理の構文的再定位
---
### ── 光速度不変原理の構文的再定位
...
What is observed is consistency _within_ a syntactic framework, not the necessity of the framework itself.
...
- A coordinate constraint is treated as a physical cause.
    
- Structural consistency is reinterpreted as dynamical necessity.
...
## 5. What This Paper Does _Not_ Claim

This paper does not propose:

- a modification of existing gravitational theories,
    
- a violation of experimental results,
    
- or an alternative dynamical model.
