...
![Two-Modes-of-Political-Theory](../assets/Two-Modes-of-Political-Theory.png)  
...
### —— Trace-Politics / Generative Politics の位置づけ

| 軸                       | 理論系譜        | 主対象                      | 時間観     | 政治の定義         | 分類                      |
| ----------------------- | ----------- | ------------------------ | ------- | ------------- | ----------------------- |
| 古典制度論                   | 国家論・憲法論     | 国家・制度                    | 静的      | 正統な統治構造       | Trace-Politics          |
| 行動論政治学                  | 投票行動・態度     | 個人行動                     | 事後分析    | 選好の集計         | Trace-Politics          |
| 機能主義                    | 政治システム論     | 機能分化                     | 均衡志向    | 安定化装置         | Trace-Politics          |
| マルクス主義                  | 階級・生産関係     | 構造決定                     | 歴史段階    | 支配の反映         | Trace-Politics          |
| エリート論                   | 権力配分        | 支配集団                     | 構造固定    | 決定主体の分析       | Trace-Politics          |
| 公共選択論                   | 合理的選択       | 利得計算                     | 即時最適化   | 合理的決定         | Trace-Politics          |
| 新制度論                    | ルール・慣行      | 制度進化                     | 準歴史的    | 制度的制約         | Trace-Politics          |
| 批判理論                    | イデオロギー      | 支配言説                     | 歴史批判    | 正当化の解体        | Trace-Politics          |
| フーコー系                   | 権力＝知        | 統治理性                     | 歴史的配置   | 権力技術          | Trace-Politics          |
| 熟議民主主義                  | 討議過程        | 合意形成                     | プロセス    | 正当性生成         | Pre-Generative（境界）      |
| プラグマティズム政治論             | 問題解決        | 行為・実験                    | 状況依存    | 実践的調整         | **Pre-Generative**      |
| シンボリック相互作用論             | 意味生成        | 相互行為                     | 進行中     | 意味の交渉         | **Pre-Generative**      |
| 社会運動論（後期）               | 動員・アイデンティティ | 過程                       | 非線形     | 構成される主体       | **Pre-Generative**      |
| **Generative Politics** | **更新構文**    | **lag / trace / update** | **非同期** | **決定が生まれる条件** | **Generative Politics** |

---

## 補助的二分法（重要）

|視点|Trace-Politics|Generative Politics|
|---|---|---|
|分析単位|決定・制度|更新・遅延|
|主語|国家・制度・主体|関係・構文|
|時間|事後・確定|進行中|
...
> 既存の政治理論は、ほぼ例外なく Trace-Politics に属してきた。  
> Generative Politics は、政治が「決定として現れる以前」の構文条件を理論化する、異なる階層の政治学である。
