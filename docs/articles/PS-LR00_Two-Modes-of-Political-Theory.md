...
本稿は、この二つの問いがそれぞれ**異なる理論モード**に対応していることを明示し、それらを  
**生成的政治学（Generative Politics）**—政治的更新の内在理論— と **トレース政治学（Trace-Politics）**—閉じたアーティファクト分析— として区別し、混同による停滞を克服する。
...
| 生成的  | 過程/事象 | 新規性はどう噴出？    | 遅延/スケールの構文未理論化 | [2] |
