...
- **Heraclitus** emphasized flux, yet lacked structural articulation.
    
- **Bergson** centered duration but did not formalize conservation.
    
- **Whitehead** articulated process and event ontology, yet without a layered projection structure.
    
- **Non-equilibrium thermodynamics** described emergent order, but retained entropy-centric framing.
    
- **Predictive processing and FEP** interpret cognition as error minimization, yet prioritize discrepancy over redistribution.
...
- $R_0$: generative relational continuity
    
- $Z_0$: minimal irreversible trace (projection)
...
\Lambda_{Z_0}
=
\int \mathrm{Tr}\left(\Pi_{Z_0}\Delta W(t)\right) d\mu,  
\qquad  
\Delta W(t):=W(t)-W(t-1).  
$$

At $R_0$, conservation implies $\mathrm{Tr}(\Delta W)=0$; irreversibility becomes measurable only through projection.  
$\Lambda_{Z_0}$ thus measures the density of irreversible updating _as trace_.
...
$$  
E_{\text{lag}} =  
\frac{\Delta \text{fixed lag}}{\text{total lag}}  
$$
...
- Generative continuity ($R-layer$)
    
- Projection trace ($Z-layer$)
    
- Conservation of redistribution
    
- Irreversible lag structure
...
Heraclitus foregrounded change (_panta rhei_), but flux remained a descriptive motif rather than a structural principle. Change was observed; it was not formalized as conserved redistribution.
...
## Heidegger's _Entwurf_ and The Relational Lag Principle in Ontology of Updating


Martin Heidegger’s late work, especially the notion of _Entwurf_ (“project”) as developed in _Being and Time_ and surrounding fragments, emphasizes existence as temporal unfolding and projection rather than as a static presence. In _Entwurf_, Dasein does not have a ready-made “nature” — rather, it projects itself into its possibilities. This is not a becoming of substance, but a **relational temporal “thrown-projection”**.

This orientation is crucial:  
Heidegger does not describe change in the ordinary sense.  
He describes **existence as the unfolding of possibilities** — as _projection_.

In the context of updating ontology, this resonates strongly with:

- **Relational updating as the fundamental operation**
    
- **Projection $Z₀$ as the trace layer**
    
- **R₀ as generative continuity**
    

But there is a further shift:

1. _Entwurf_ emphasizes temporal projection as existential structure  
...
2. Updating ontology makes **irreversible redistribution** primary  
    — Time is a _result of_ irreversible redistribution, not the prior horizon
    
3. R/Z distinction can be understood as:
    
    - R₀: _Entwurf_’s temporalizing field
...
5. Therefore updating ontology _extends_ Heidegger by:
...
On Heidegger’s terms, Dasein’s Being is disclosed _in its temporal unfolding_ —  
...
> Heidegger’s _Entwurf_ anticipates the relational-temporal direction,  
...
- Heidegger’s account is phenomenological and descriptive
    
- Updating ontology offers structural grounding for that description
    

It paves the way for a **philosophically rigorous continuation** of Heidegger’s insight into Dasein as _project_ — not by reinserting traditional temporality, but by situating projection in preserved relational updating.
...
Thus, Heidegger’s _Entwurf_ and updating ontology are not in conflict, but in continuity:  
