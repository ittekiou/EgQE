---
title: HEG-13｜四次元は零点構文である ── Hermann Minkowski と Albert Einstein の再文脈化
title_en: HEG-13｜Four Dimensions as Zero-Point Syntax — Recontextualizing Hermann Minkowski and Albert Einstein
---
# 四次元は零点構文である
...
それとも、物理法則を整理するための**表現形式**にすぎないのだろうか。

本稿は後者の立場をとる。

四次元とは宇宙の固有構造ではない。  
それは**零点を固定することで生成される座標構文**である。
...
あらゆる座標系は基準点を必要とする。  
物理学ではそれは原点、すなわち**零点**として暗黙に導入される。
...
1908年の講演 _Space and Time_ において、ミンコフスキーは次のように述べた。
...
それは物理法則を統一的に表現するための **高度な記述形式**である。
...
In his 1908 lecture _Space and Time_, Hermann Minkowski famously declared:
