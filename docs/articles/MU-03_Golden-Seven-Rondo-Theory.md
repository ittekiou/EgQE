...
This produces what we define as a **Rondo Structure**: circular closure at the global level and spiral persistence at the subset level. We show that 7 is the minimal cardinality greater than 1 that resists absorption into proper sublattices of $\mathbb{Z}_{12}$. The theory provides a structural reinterpretation of heptatonic musical organization as minimal envelopment-rotation within a closed lattice.
