---
layout: math
title: TS-13｜時間とは何か ── lag前提による再構築
title_en: TS-13｜What is Time? — Reconstruction from Lag Ontology —
---
# 時間とは何か
## ── lag前提による再構築
...
![time-speed](../assets/time-speed.png)  
...
![velocity-time](../assets/velocity-time.png)  
