...
| **Sign Action Theory（伝統的用法）** | **Sign Act Theory（SAT）**            | EgQEでは「記号が自ら act する」ことを主題化する。ActionではなくActを選ぶのは「一回性・痕跡主権」を担保するため。その上で、**Sign Action Theory**を「記号自体が行為する理論」として再定義する。 |
