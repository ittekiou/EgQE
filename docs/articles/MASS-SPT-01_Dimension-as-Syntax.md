---
title: MASS-SPT-01｜Dimension as Syntax──Zero-Point Construction and the Emergence, Transition, and Dissolution of Dimensions
---
# **Dimension as Syntax**
...
By introducing the concept of _zero-point syntax_, we show that dimensions appear, transition, and dissolve depending on whether the syntactic system admits a single zero-point, multiple zero-points, or none at all.
...
**Figure 1.** _Syntactic phases of dimension formation via zero-point construction._  
