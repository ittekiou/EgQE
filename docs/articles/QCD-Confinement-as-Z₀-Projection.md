---
layout: math
title: QCD閉じ込め過程における関係保存の実験的検証：Lag構文による再解釈
title_en: QCD Confinement as Z₀-Projection
---
...
![R₀–lag–Z₀_projection_in_Λ–Λ̄_formation](../assets/R₀–lag–Z₀_projection_in_Λ–Λ̄_formation.png)  
