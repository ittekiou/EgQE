...
- that physical states are locally specifiable,
    
- that the global behavior of a system is the direct product of its parts, and
    
- that correlations must be grounded in pre-existing local properties.
