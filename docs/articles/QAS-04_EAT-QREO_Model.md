---
layout: math
title: QAS-04｜EAT-QREO Model ── 研究は問いから始まらない
---
...
EAT-QREO Modelは、[Nomadic Tracing](https://camp-us.net/articles/QAS-03_Tracing-Nomad-Research.html)の更新過程を記述するモデルとして位置づけることができる。

**Nomadic Tracing**では、研究のdestinationをあらかじめ固定しない。
