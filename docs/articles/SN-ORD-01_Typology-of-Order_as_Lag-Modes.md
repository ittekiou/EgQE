---
title: SN-ORDER-01｜秩序生成の類型論 ── 黄金環φにおける分岐と更新の役割
title_en: SN-ORDER-01｜A Typology of Order as Modes of Lag — Bifurcation at φ and the Role of Update in Persistence —
layout: math
---
### SN-ORDER-01
# 秩序生成の類型論
...
### Figure 2: 秩序生成の類型論マップ（Order Generation Typology Map）

![order_typology_map](../assets/order_typology_map.png)  
_Figure 2: 秩序生成の類型論マップ（Order Generation Typology Map）_  
