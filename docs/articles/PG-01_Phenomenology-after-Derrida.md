---
layout: math
title: PG-01｜生成する時間と露出するepokhé ── デリダ以後の現象学
title_en: PG-01｜Time as Generation and Epoché as Exposure — Phenomenology after Derrida
...
本稿は、生成をめぐるこの緊張を再配置し、それを**非閉包的な持続運動として記述する試み**である。
...
ここで生成は、問題ではなく、**続き続ける運動**として理解される。
...
---
<p align="center">| Drafted Mar 26, 2026 · Web Mar 26, 2026 |</p>