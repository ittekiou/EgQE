---
layout: math
title: MC-01｜Materia Mutans (v0.9)
title_en: MC-01｜Materia Mutans (v0.9) ── How Can Change Change the Space of Possible Change?
---
...
01 Fire — _Matter changes._  
02 Catalyst — _Matter affects HOW Matter changes._  
03 COH — _Matter has many ways to change._  
04 N — _Where does a HOW appear?_  
05 P — _Can one HOW be coupled to another HOW?_  
06 S — _How can a relation persist while remaining changeable?_  
07 NPS — _What happens when different HOWs encounter?_
...
$$
\boxed{  
A\ process\ can\ persist\ while\ its\ constituent\ Matter\ changes.  
}  
$$
...
のように、触媒cycleのなかで一時的な変化を経ながら、**netでは再びreaction可能な状態へ戻る**ことができる。

$$
\boxed{  
Catalyst\ can\ change\ during\ reaction.  
}  
$$
...
$$
\boxed{  
\text{how the system can approach it}  
}  
$$
...
$$
\boxed{  
Catalyst = a\ relational\ role\ in\ a\ reaction.  
}  
$$
...
$$
\boxed{  
Catalysis\ changes\ reaction\ kinetics\ and\ available\ pathways.  
}  
$$
...
$$
\boxed{  
\text{How many HOWs can Matter have?}  
}  
$$
...
$$
\boxed{  
C\ opens\ a\ large\ space\ of\ chemical\ relations.  
}  
$$
...
$$
\boxed{  
H\ participates\ in\ many\ modes\ of\ chemical\ change.  
}  
$$
...
$$
\boxed{  
O\ strongly\ reshapes\ chemical\ relations\ and\ reactivity.  
}  
$$
...
$$
\boxed{  
COH\ exposes\ many\ possible\ HOWs.  
}  
$$
...
$$
\boxed{  
\text{What happens to HOW when N enters?}  
}  
$$
...
$$
\boxed{  
\text{local relation affects local reactivity.}  
}  
$$
...
$$
\boxed{  
N\ chemistry\ exposes\ differentiated\ local\ HOWs.  
}  
$$
...
$$
\boxed{  
Current\ state\ affects\ possible\ next\ HOWs.  
}  
$$
...
N\ chemistry:  
\quad  
Local\ relation\ affects\ local\ HOW  
$$
...
$$
\boxed{  
\text{Can one HOW be coupled to another HOW?}  
}  
$$
...
$$
\boxed{  
\text{What happens to HOW when P enters?}  
}  
$$
...
reaction全体でfree energyが下がりうるのは、生成物側の結合、電子状態、共鳴、溶媒和などを含む**system全体の差**による。
...
$$
\boxed{  
HOWs\ do\ not\ couple\ without\ Matter.  
}  
$$
...
$$
\boxed{  
\text{one change can be chemically related to another change}  
}  
$$
...
$$
\boxed{  
Transfer\ can\ connect\ local\ changes.  
}  
$$
...
$$
\boxed{  
P\ chemistry\ exposes\ chemical\ coupling\ between\ changes\ ?  
}  
$$
...
$$
\boxed{  
A\ change\ here\ can\ affect\ a\ possible\ change\ there.  
}  
$$
...
$$
\boxed{  
\text{How can a relation persist while remaining changeable?}  
}  
$$
...
$$
\boxed{  
\text{What\ happens\ to\ HOW\ when\ S\ enters?}  
}
$$
...
$$
\boxed{N\ chemistry\ exposed\ a\ question.}  
$$

$$
\boxed{P\ chemistry\ exposed\ another\ question.}  
$$

$$
\boxed{S\ chemistry\ exposed\ another\ question.}  
$$
...
$$
\text{How does a local relation affect what can happen next?}  
$$

$$
\text{How can one change affect another change?}  
$$

$$
\text{What can persist through change?}  
$$
...
$$
State_2 \xrightarrow{HOW_2} State_3  
$$

$$
State_3 \xrightarrow{HOW_3} State_4  
$$
...
という差を観察するための、**仮の観測線**としてなら置けるかもしれない。
...
[https://camp-us.net/articles/TUP-01_TUP-Again_How-Is-Updating.html](https://camp-us.net/articles/TUP-01_TUP-Again_How-Is-Updating.html)
...
[https://camp-us.net/articles/TUP-LIF-01_Life-to-TUP.html](https://camp-us.net/articles/TUP-LIF-01_Life-to-TUP.html)  
...
[https://camp-us.net/articles/SN-LIF-07_From-COH-to-NOCH_The-Fold-from-Metabolism-to-Information.html](https://camp-us.net/articles/SN-LIF-07_From-COH-to-NOCH_The-Fold-from-Metabolism-to-Information.html)
...
[https://camp-us.net/articles/SN-LIF-11_CHONPS-Syntax_Orientation-Elements.html](https://camp-us.net/articles/SN-LIF-11_CHONPS-Syntax_Orientation-Elements.html)
...
[https://camp-us.net/articles/SN-LIF-10_Life-and-Matter_Transitional-Phase.html](https://camp-us.net/articles/SN-LIF-10_Life-and-Matter_Transitional-Phase.html)
...
[https://camp-us.net/articles/Core_HEG-TUP_Trace-Updating-Ontology.html](https://camp-us.net/articles/Core_HEG-TUP_Trace-Updating-Ontology.html)
...
$$
\begin{array}{ccccc} Matter &\rightarrow& Materia\ Mutans &\rightarrow& ?\\[4pt] &&&\boxed{Life?}&\\[-2pt] &&&&\\[-6pt] Homo\ editus &\leftarrow& Editing &\leftarrow& ? \end{array}
$$

$$
\boxed{ What\ remains\ unexplained\ between\ Materia\ Mutans\ and\ Homo\ editus? }
$$

$$
\boxed{\text{Life remains a mystery.}}
$$
