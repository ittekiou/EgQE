...
対称性破れを超えて秩序を再解釈するため、本稿では _lag_ を構造量として導入する。
...
<svg xmlns="http://www.w3.org/2000/svg" width="920" height="520" viewBox="0 0 920 520" role="img" aria-label="Figure 1: Conceptual lag distribution across spatial scales">
  <!-- Background (dark-mode safe) -->
  <rect x="0" y="0" width="920" height="520" fill="#ffffff"/>

  <!-- Plot area -->
  <rect x="90" y="60" width="760" height="380" fill="none" stroke="#111" stroke-width="2"/>

  <!-- Axes labels -->
  <text x="470" y="495" font-family="system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial" font-size="16" fill="#111" text-anchor="middle">
    spatial scale r
  </text>

  <!-- y-axis label (rotated) -->
  <g transform="translate(28,250) rotate(-90)">
    <text x="0" y="0" font-family="system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial" font-size="16" fill="#111" text-anchor="middle">
      lag intensity L(r)
    </text>
  </g>

  <!-- Minimal ticks (no numbers) -->
  <g stroke="#111" stroke-width="1">
    <!-- x ticks -->
    <line x1="190" y1="440" x2="190" y2="448"/>
    <line x1="330" y1="440" x2="330" y2="448"/>
    <line x1="470" y1="440" x2="470" y2="448"/>
    <line x1="610" y1="440" x2="610" y2="448"/>
    <line x1="750" y1="440" x2="750" y2="448"/>
    <!-- y ticks -->
    <line x1="82" y1="380" x2="90" y2="380"/>
    <line x1="82" y1="310" x2="90" y2="310"/>
    <line x1="82" y1="240" x2="90" y2="240"/>
    <line x1="82" y1="170" x2="90" y2="170"/>
    <line x1="82" y1="100" x2="90" y2="100"/>
  </g>

  <!-- Curves (monochrome) -->
  <!-- 1) Crystal: low, nearly flat -->
  <path d="M110 410
           C 220 410, 320 408, 430 407
           C 560 406, 690 406, 830 406"
        fill="none" stroke="#111" stroke-width="3"/>

  <!-- 2) Glass: heterogeneous, with boson-peak-like bump and roughness -->
  <path d="M110 380
           C 170 360, 210 320, 250 280
           C 290 240, 335 255, 360 285
           C 390 320, 420 310, 450 295
           C 490 275, 520 290, 555 310
           C 590 332, 630 320, 665 305
           C 705 288, 760 295, 830 305"
        fill="none" stroke="#111" stroke-width="3" stroke-dasharray="10 7"/>

  <!-- 3) Ideal non-crystal: moderate at short range, smoothly suppressed at long range -->
  <path d="M110 360
           C 200 330, 290 315, 380 305
           C 500 292, 640 300, 830 320"
        fill="none" stroke="#111" stroke-width="3"/>

  <!-- Legend (minimal) -->
  <g font-family="system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial" font-size="14" fill="#111">
    <rect x="550" y="78" width="285" height="96" fill="#fff" stroke="#111" stroke-width="1.5"/>
    <!-- Crystal -->
    <line x1="565" y1="105" x2="615" y2="105" stroke="#111" stroke-width="3"/>
    <text x="625" y="110">Crystal (fixed lag)</text>
    <!-- Glass -->
    <line x1="565" y1="130" x2="615" y2="130" stroke="#111" stroke-width="3" stroke-dasharray="10 7"/>
    <text x="625" y="135">Glass (heterogeneous lag)</text>
    <!-- Ideal non-crystal -->
    <line x1="565" y1="155" x2="615" y2="155" stroke="#111" stroke-width="3"/>
    <text x="625" y="160">Ideal non-crystal (regulated lag)</text>
  </g>

  <!-- Figure label -->
  <text x="90" y="40" font-family="system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial" font-size="16" fill="#111">
...
より根源的には、秩序とは **更新の伝播が過不足なく制御される状態**である。
...
- Nature Materials  
    _Ideal non-crystals as a distinct form of ordered states without symmetry breaking_  
    Nature Materials (2026).  
    DOI: [10.1038/s41563-026-02496-8](https://doi.org/10.1038/s41563-026-02496-8)  
