---
layout: math
title: GE-04｜座標はどこから来るのか ── 複数traceの関係と比較可能性の発生
title_en: GE-04｜Where Does Coordinate Come From? ── Relations Among Traces and the Emergence of Comparability
---
...
[GE-03](https://camp-us.net/articles/GE-03_Why-Closure-Tend-to-Occur.html)では、trace が局所に非対称性を残し、その蓄積が stabilize を経て closure tendency を生むことを示した。

しかし [GE-01](https://camp-us.net/articles/GE-01_Pre-π-Geometry_Generative-Cycle-of-Closure.html) の生成循環には、まだ未解明の区間がある。
...
In [GE-03](https://camp-us.net/articles/GE-03_Why-Closure-Tend-to-Occur.html), it was shown that trace leaves asymmetry locally, and that its accumulation gives rise to closure tendency through stabilization.

Yet one interval in the generative cycle of [GE-01](https://camp-us.net/articles/GE-01_Pre-π-Geometry_Generative-Cycle-of-Closure.html) remains unexplained.
...
[GE-03](https://camp-us.net/articles/GE-03_Why-Closure-Tend-to-Occur.html) では単独の trace を扱った。
...
[GE-03](https://camp-us.net/articles/GE-03_Why-Closure-Tend-to-Occur.html) addressed a single trace.
...
[GE-01](https://camp-us.net/articles/GE-01_Pre-π-Geometry_Generative-Cycle-of-Closure.html) で「与えられていた」座標と順序は、trace の関係から発生するものとして読み直される。
...
The coordinate and ordering that were "given" in [GE-01](https://camp-us.net/articles/GE-01_Pre-π-Geometry_Generative-Cycle-of-Closure.html) are now read as emerging from the relations among traces.
