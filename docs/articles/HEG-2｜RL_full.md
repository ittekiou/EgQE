...
まるで宇宙がビッグバンの初期構造を持つように、言語もまた、**構文という相互関係の密度分布**をもって始まる。
...
**この意味で言語とは、138億年前のビッグバンから現在まで続く宇宙の物語を、人類が発見した独自の方法で語り直す装置**とも言える。星の生成と消滅、銀河の衝突と融合、生命の誕生と進化──これらすべてが**関係の変容のドラマ**であり、言語はそのドラマを**構文・意味・語用の三層で再現する楽器**なのだ。
...
意味は構文から生まれ、語用によって実践される。そしてその語用は、**身体という場を必要とする。**

私たちは、意味のズレに敏感だ。声の抑揚、言い淀み、間（ま）、ちょっとした手振り。そこに語用が宿る。構文はAIにも生成できるが、語用は**身体性をもった関係の場においてしか発生しない。**

だからこそ、ホモ・サピエンスは語用を生きる存在であり、AIは語用を模倣する存在に留まっている。
