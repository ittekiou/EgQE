---
layout: math
title: PRT-02｜Velocity Before Time — Z₀と速度の起源：lagに基づく速度定義と光速極限
title_en: "PRT-02｜Velocity Before Time — Z₀ and the Origin of Speed: Toward a Lag-Based Definition of Velocity and the Light-Speed Limit"
---
_Projection, Recursion and Time._  
## **Velocity Before Time — Z₀と速度の起源**
### _lagに基づく速度定義と光速極限_
# **Velocity Before Time — Z₀ and the Origin of Speed**
## _Toward a Lag-Based Definition of Velocity and the Light-Speed Limit_
...
- distance is measurable within time
...
- but no persistence exists
    
- no trace accumulates
...
- propagation without retention
    
- encounter without folding
    
- motion without persistence
...
- propagation no longer dissipates
    
- difference begins to fold
...
- propagation alone → no time
    
- recursive propagation → time
